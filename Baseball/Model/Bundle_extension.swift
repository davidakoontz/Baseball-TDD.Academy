...
//  also: https://www.hackingwithswift.com/read/7/3/parsing-json-using-the-codable-protocol
//  To Add a data.json file to the App Bundle you
    ...
    func decode<T: Decodable>(_ type: T.Type, from file: String,
        ...
        do {
            ...
            fatalError("""
                ...
                \(type) value – \(context.debugDescription)
                """)
